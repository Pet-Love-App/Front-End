        ...
        <View style={styles.container}>
            ...
            <View style={styles.infoSection}>
                ...
                <TouchableOpacity onPress={openDetailsModal} style={styles.detailsButton}>
                    <Text numberOfLines={3} style={styles.detailsText}>{details}</Text>
                </TouchableOpacity>
            </View>
                ...
                <View style={styles.modalOverlay}>
                    <View style={styles.modalContent}>
                        ...
                        <View style={styles.modalActions}>
                            <TouchableOpacity onPress={() => setDetailsModalVisible(false)} style={styles.modalButton}>
                                <Text style={styles.modalButtonText}>取消</Text>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={saveDetails} style={[styles.modalButton, styles.saveButton]}>
