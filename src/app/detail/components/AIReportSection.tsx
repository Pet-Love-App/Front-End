  ...
  if (isStreamingMode && streamingState) {
    return (
      <Card
        ...
        borderRadius="$6"
        borderWidth={2}
        borderColor={colors.tintAlpha40 as any}
        overflow="hidden"
      >
        {/* 头部 */}
        <Card.Header paddingBottom="$2" paddingHorizontal="$4" paddingTop="$4">
          <XStack alignItems="center" gap="$3" marginBottom="$3">
            <YStack
              ...
              borderRadius="$4"
              borderWidth={2}
              borderColor={colors.tintAlpha50 as any}
            >
        ...
        <Card.Header paddingHorizontal="$4" paddingVertical="$5">
          <YStack alignItems="center" gap="$4">
            <YStack
              ...
              alignItems="center"
              justifyContent="center"
              backgroundColor={colors.tintAlpha10 as any}
              borderRadius="$6"
            >
      ...
      <YStack gap="$2.5">
        ...
        <XStack gap="$2" flexWrap="wrap">
          {items.map((item, i) => (
            ...
            >
              <Text fontSize="$3" color={textColor as any} numberOfLines={1}>
                {item}
              </Text>
            </YStack>
          ))}
